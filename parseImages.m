...
%% Or don't do this cause it makes things look like shit:

% %% Go through images and histeq to the same distribution, re-centered at 255/2
% 
% % First get all images and stack
% aimgs = [];
% for ci = 1:length(categories)
%     imgs = info.imgs.(categories{ci});
%     for ii = 1:length(imgs)
